		...
		<section className="py-16 bg-slate-100" id="ressources-preview">
			<div className="container mx-auto px-4">
						...
						>
							<Card className="h-full flex flex-col shadow-lg hover:shadow-xl transition-shadow duration-300">
								...
								<CardContent className="flex-grow">
									<CardDescription className="text-base text-center h-16 overflow-hidden">
				...
				<div className="text-center mt-12">
					<Link to="/ressources">
						<button className="bg-ivory-green text-white px-6 py-2 rounded-md hover:bg-ivory-orange">
